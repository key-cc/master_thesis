...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default='Res3D', type=str, help='(P3D | R21D | Res3D | ConvLSTM | ARTNet | ')
    ...
    #logger = get_logger('Res3D.log')
    if opt.model == 'ConvLSTM':
        logger = get_logger('ConvLSTM.log')
    elif opt.model == 'Res3D':
        logger = get_logger('Res3D.log')
    elif opt.model == 'P3D':
       logger = get_logger('P3D.log')
    elif opt.model == 'R21D':
       logger = get_logger('R21D.log')
    elif opt.model == 'ARTNet':
       logger = get_logger('ARTNet.log')
