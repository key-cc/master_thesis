...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.1), test_cfg=dict(max_testing_views=4, average_clips='prob'), cls_head=dict(num_classes=101, spatial_type='avg'),)
...
work_dir = './work_dirs/ucf101_swin_small_patch244_window877'
